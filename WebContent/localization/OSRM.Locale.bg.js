...
"GUI_END": "Край",
"GUI_RESET": "&nbsp;&nbsp;Изчисти&nbsp;&nbsp;",
"GUI_ZOOM": "Приближи маршрута",
"GUI_SEARCH": "&nbsp;&nbsp;Покажи&nbsp;&nbsp;",
"GUI_REVERSE": "Размени",
"GUI_START_TOOLTIP": "Въведи начало",
"GUI_END_TOOLTIP": "Въведи карйна цел",
"GUI_LEGAL_NOTICE": "GUI2 v"+OSRM.VERSION+" "+OSRM.DATE+" - OSRM хостван от <a href='http://algo2.iti.kit.edu/'>KIT</a> - Геолокация от <a href='http://www.osm.org/'>OSM</a>",
// config
"GUI_CONFIGURATION": "Конфигурация",
"GUI_LANGUAGE": "Език",
"GUI_UNITS": "Мерни единици",
"GUI_KILOMETERS": "Километри",
"GUI_MILES": "Мили",
"GUI_DATA_TIMESTAMP": "дата",
// mapping
